    ...
    return (
        <Section>
            <div className=' block mt-56 xs:mt-36 xss:mt-36 mb-28 '>
                ...
                <h1 className='text-7xl xs:text-[45px] xs:leading-[50px] xss:text-4xl mx-auto text-center font-semibold xss:font-bold max-w-4xl  tracking-tight text-[#e6e1c5] opacity-90'>
                    <Balancer>
