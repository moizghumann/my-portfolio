...
const Contact = () => {
    return (
        <Section>
            <div className='  flex flex-col justify-center items-center mb-20 xs:mb-20 xs:pb-10 xs:pt-7 xss:mb-0 xss:h-fit xss:pb-7 xss:pt-[137px] xt:pb-0 xl:mb-44 xl:mt-40 xm:mb-50 xms:mb-24'>
